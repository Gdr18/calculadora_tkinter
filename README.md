...
1. Descarga el instalador que se encuentra en [[/installer/calculadora_v1.0.1](https://github.com/Gdr18/calculadora-tkinter/blob/main/installer/calculadora_v1.0.1.exe). A continuación clica en '*Raw*'.
